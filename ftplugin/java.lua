...
local config = {
  ...
  cmd = {
    ...
    '-jar', '/home/hin/.config/nvim/jdtls/jdt-language-server-1.8.0-202201261434/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',

    -- 💀
    -- Must point to the eclipse.jdt.ls installation
    -- Change to one of `linux` or `win`
        -- '-configuration', '/home/hin/.local/share/nvim/lsp_servers/jdtls/config_linux/',
    '-configuration', '/home/hin/.config/nvim/jdtls/jdt-language-server-1.8.0-202201261434/config_linux/',
